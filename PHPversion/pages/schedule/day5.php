...
<body>
    ...
    <div class="schedule-container">
      <?php
        ...
        $journeyIDs = [501, 502]; // Journey IDs for the schedule
          ...
          if ($result->num_rows > 0) {
            while($row = $result->fetch_assoc()) {
              if ($counter < 1){
                ...
                echo '<h3>Date: 2024-07-15</h3>';//use counter to change date
                echo '<p>Location: ' . $row["jName"] . '</p>';
                echo '<p id="' . $id . '">Journey ' . $day . ':</p>';
                echo '<img src="../../image/attractions/' . ($id == 501 ? '501.jpg' : '502.jpg') . '" alt="' . $row["jName"] . '">';
                echo '<ul>';
            ...
            echo '<p id="' . $id . '">Journey ' . $day . ':</p>';
            echo '<img src="../../image/attractions/' . ($id == 501 ? '501.jpg' : '502.jpg') . '" alt="Not Found">';
            echo '<ul>';
    ...
    <?php if ($userRole == 'student'): ?>
        <div class="submit-container">
            <button class="submit-button" onclick="loadSchedule('../submit/day5.php')">Submit</button>
        </div>
    <?php endif; ?>

...
<body>
    <div class="menu">
        ...
        <ul class="menu-items">
            ...
            <?php if ($userRole == 'teacher'): ?>
                <li><a href="../submission/day2.php">Submit</a></li>
            <?php endif; ?>
        </ul>
    </div>
    ...
    <div class="schedule-container">
      <?php
        ...
        $journeyIDs = [201, 202]; // Journey IDs for the schedule
        $day = 200;
          ...
          if ($result->num_rows > 0) {
            while($row = $result->fetch_assoc()) {
              if ($counter < 1){
                ...
                echo '<h3>Date: 2024-07-12</h3>';//use counter to change date
                echo '<p>Location: ' . $row["jName"] . '</p>';
                echo '<p id="' . $id . '">Journey ' . ($id - 200) . ':</p>';
                echo '<img src="../../image/attractions/' . ($id == 201 ? '201.jpg' : '202.jpg') . '" alt="' . $row["jName"] . '">';
                echo '<ul>';
            ...
            echo '<p id="' . $id . '">Journey ' . ($id - 200) . ':</p>';
            echo '<img src="../../image/attractions/' . ($id == 201 ? '201.jpg' : '202.jpg') . '" alt="Not Found">';
            echo '<ul>';
    ...
    <?php if ($userRole == 'student'): ?>
        <div class="submit-container">
            <button class="submit-button" onclick="loadSchedule('../submit/day2.php')">Submit</button>
        </div>
    <?php endif; ?>

...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $journeyIDs = [501, 502]; // Adjust journey IDs based on the day
...
<body>
    <div class="menu">
        ...
        <ul class="menu-items">
            <li><a href="../schedule/day5.php">Schedule</a></li>
    ...
    <div class="submit-form">
        <div class="card">
            ...
            <form class="form" id="submit-form" action="day5.php" method="post" enctype="multipart/form-data">
                <div class="group">

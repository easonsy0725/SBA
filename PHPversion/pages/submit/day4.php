...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $journeyIDs = [401, 402, 403]; // Adjust journey IDs based on the day
...
<body>
    <div class="menu">
        ...
        <ul class="menu-items">
            <li><a href="../schedule/day4.php">Schedule</a></li>
    ...
    <div class="submit-form">
        <div class="card">
            ...
            <form class="form" id="submit-form" action="day4.php" method="post" enctype="multipart/form-data">
                <div class="group">
                ...
                <div class="group">
                    <input type="file" id="fileInput3" name="image3" accept="image/*" capture="camera">
                    <button class="custom-button" type="button" onclick="openFileInput('fileInput3');">Take Photo For Journey 3</button>
                    <div class="preview" id="preview3"></div>
                    <div class="delete-btn" onclick="deletePreview('preview')"></div>
                </div>

                <div class="group">
                    <textarea placeholder="" id="comment3" name="comment3" rows="5"></textarea>
                    <label class="journey" for="comment3">Comment For Journey 3</label>
                </div>

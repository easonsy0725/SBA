...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $journeyIDs = [101, 102]; // Adjust journey IDs based on the day
...
<body>
    ...
    <div class="dateSelecter">
        ...
        <button onclick="loadSchedule('submit/day2.php')">12</button>
        <button onclick="loadSchedule('submit/day3.php')">13</button>
        <button onclick="loadSchedule('submit/day4.php')">14</button>
        <button onclick="loadSchedule('submit/day5.php')">15</button>
    </div>

    <div class="submit-form">
        <div class="card">
            <span class="title">Day 1</span>
            <form class="form" id="submit-form" action="submit.php" method="post" enctype="multipart/form-data">
                <div class="group">
